...
ssh kc1 "docker service update --force --update-parallelism 1 --update-delay 30s --update-failure-action=rollback --update-max-failure-ratio 0 qaserv_index_service_$3"
ssh kc1 "docker service update --force --update-parallelism 1 --update-delay 30s --update-failure-action=rollback --update-max-failure-ratio 0 qaserv_gateway"
